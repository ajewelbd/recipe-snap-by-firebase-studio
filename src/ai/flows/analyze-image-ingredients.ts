 ...
 * - AnalyzeImageIngredientsInput - The input type for the analyzeImageIngredients function.
 * - AnalyzeImageIngredientsOutput - The return type for the analyzeImageIngredients function.
 */
...
const AnalyzeImageIngredientsOutputSchema = z.object({
  ingredients: z
    .array(z.string())
    .describe('A list of ingredients identified in the image.'),
});
