...
import { Globe, History, LogOut, Moon, Sun } from 'lucide-react';
      ...
      <div className="container mx-auto flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-1 sm:gap-2">
          ...
          <DropdownMenu>
           ...
           <Button variant="outline" size="icon" onClick={() => setTheme(theme === "dark" ? "light" : "dark")} className="relative w-9 h-9">
