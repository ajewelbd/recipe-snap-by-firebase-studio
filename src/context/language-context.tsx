...
export const content = {
    en: {
        ...
        newRecipe: {
            ...
            ingredientsPlaceholder: 'e.g., 2 cups flour, 1 cup sugar, and 3 eggs',
            timeLabel: 'Time to Cook',
            timePlaceholder: 'e.g., 30 minutes',
            detailsLabel: 'Recipe Details',
            detailsPlaceholder: 'List ingredients and step-by-step instructions here...',
            featuredImageLabel: 'Featured Image',
            resultPhotosLabel: 'Final Result Photos',
            publicLabel: 'Make Recipe Public',
            publicDescription: 'Allow other users to see this recipe.',
            successTitle: 'Recipe Saved!',
            successDescription: 'Your new recipe has been successfully saved to your collection.',
    ...
    bn: {
        ...
        newRecipe: {
            ...
            editTitle: 'রেসিপি সম্পাদনা করুন',
            loading: 'লোড হচ্ছে...',
            saveButton: 'রেসিপি সংরক্ষণ করুন',
            updateButton: 'রেসিপি আপডেট করুন',
            titleLabel: 'শিরোনাম',
            titlePlaceholder: 'যেমন, নানীর আপেল পাই',
            ingredientsLabel: 'উপাদান',
            ingredientsPlaceholder: 'যেমন, ২ কাপ ময়দা, ১ কাপ চিনি, এবং ৩টি ডিম',
            timeLabel: 'রান্নার সময়',
            timePlaceholder: 'যেমন, ৩০ মিনিট',
            detailsLabel: 'রেসিপির বিবরণ',
            detailsPlaceholder: 'এখানে উপাদান এবং ধাপে ধাপে নির্দেশাবলী তালিকাভুক্ত করুন...',
            featuredImageLabel: 'ফিচার করা ছবি',
            resultPhotosLabel: 'চূড়ান্ত ফলাফলের ছবি',
            publicLabel: 'রেসিপিটি পাবলিক করুন',
            publicDescription: 'অন্যান্য ব্যবহারকারীদের এই রেসিপি দেখতে অনুমতি দিন।',
            successTitle: 'রেসিপি সংরক্ষিত!',
            successDescription: 'আপনার নতুন রেসিপি সফলভাবে আপনার সংগ্রহে সংরক্ষিত হয়েছে।',
            viewMyRecipes: 'আমার রেসিপিগুলো দেখুন',
            createAnother: 'আরেকটি রেসিপি তৈরি করুন',
        },
        toast: {
            error: {
